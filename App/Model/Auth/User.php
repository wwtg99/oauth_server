...
//    use TOpenAuth;
    ...
    public static $head = [User::KEY_USER_ID, User::KEY_USER_NAME, User::KEY_USER_PASSWORD, User::KEY_USER_EMAIL, 'label', 'department_id', 'department', 'descr', 'superuser', 'roles', 'created_at'];
